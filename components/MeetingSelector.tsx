...
const MeetingSelector = () => {
	...
	return (
      ...
      window.location.replace(`?id=${encodeURI(newId)}`)
	    ...
	    <input className = "text-center border w-5/6 p-2  border-gray-600 placeholder-gray-600 text-lg" placeholder="Enter Meeting Name" value = {newId} onChange = {(e) => setNewId(e.currentTarget.value)} />
