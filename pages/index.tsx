...
const Home: NextPage = () => {
  ...
  const MeetingBody = id ? Scoring : MeetingSelector
    ...
    <div className="container max-w-2xl mx-auto">
      <Head>
        <title>Rate {id ? id : 'Your Meeting'}!</title>
      ...
      <main className="">
        <h1 className="text-5xl text-center m-10">
          { id ? <>Rate <em>{id}</em> <ShareIcon  className="inline cursor-pointer" xlinkTitle="Copy share url to clipboard" onClick={copyUrl}/></> : <>Rate your Meeting</> }
        </h1>
          <MeetingBody id={id || ''}/>
      </main>
      <ToastContainer />
